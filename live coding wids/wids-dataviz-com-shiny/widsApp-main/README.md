...
- Setar como working diretório a pasta widsApp-main
  - `setwd("~/caminho/ate/widsapp/naive")`
- No canto superior esquerdo, clique no menu _File_ e depois _Abrir Projeto.._/_Abrir arquivo_ e selecione o arquivo **widsApp.Rproj**
- No R, rode `source("dev/run_app.R")` 
- Depois rode `run_app()`
